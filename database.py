...
# 1. lets see if it works (an object wil be created at a memory loc)
...
# 6. Comment 5 after checking the db's now we want to only use db as testdb,
# so  at 0. in mydb add database as testdb
